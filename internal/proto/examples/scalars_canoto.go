...
var (
	// TODO: should investigate if hardcoding these tags inline would be faster
	int32Tag    = canoto.Tag(1, canoto.Varint)
	int64Tag    = canoto.Tag(2, canoto.Varint)
	uint32Tag   = canoto.Tag(3, canoto.Varint)
	uint64Tag   = canoto.Tag(4, canoto.Varint)
	sint32Tag   = canoto.Tag(5, canoto.Varint)
	sint64Tag   = canoto.Tag(6, canoto.Varint)
	fixed32Tag  = canoto.Tag(7, canoto.I32)
	fixed64Tag  = canoto.Tag(8, canoto.I64)
	sfixed32Tag = canoto.Tag(9, canoto.I32)
	sfixed64Tag = canoto.Tag(10, canoto.I64)
	boolTag     = canoto.Tag(11, canoto.Varint)
	stringTag   = canoto.Tag(12, canoto.Len)
	bytesTag    = canoto.Tag(13, canoto.Len)

	// TODO: tag sizes should be constants instead of variables
